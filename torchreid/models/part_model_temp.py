...
class CPM(nn.Module):
    def _init_(self, depth_dim, num_features_part=128, use_relu=False, dilation=1, initialize=True):
        super(CPM, self)._init_()
        #self.pretrained = '/Users/abhiii/soccernet/sn-reid/torchreid/pretrained_pose/pose_iter_440000.caffemodel'
